...
export default function HomePage() {
    ...
    const [data, setData] = useState({ name: "", studentIdentity:"", email: "", contact: "", event: "celebrity-event" })
    ...
    const paymentHandler = async (e) => {
        e.preventDefault()
        const paymentResponse = await fetch('http://localhost:3000/order', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            }
                    ...
                    const handleSubmit = async(e) => {
                            ...
                            try{
                                ...
                                if(json.success){
                                    setRegistrationNumber(json.data.registrationNumber)
                                    setRegistrationScreen(true)
                                    setData({name: "", studentIdentity:"", email: "", contact: "", event: "celebrity-event"})
        ...
        <div className='home-page'>
            ...
            <div className="about-section" id='about'>
                ...
                <div className="about-section-right">
                    ...
                    <a href="https://wa.me/919666306876" className="btn-a link-a" target='_blank'>Connect With Us</a>
                </div>
            </div>
            ...
            <footer className="footer">
                <h4>This Website is Designed & Developed By <span>JSN Uday Kumar and P.S.S.Vaishalini</span></h4>
            </footer>
